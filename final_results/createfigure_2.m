function createfigure(X1, Y1, X2, Y2, Y3)
...
%  Auto-generated by MATLAB on 09-Nov-2016 12:24:12
...
% Create plot
plot(X1,Y1,'Parent',subplot1,'DisplayName','Original Data','Color',[0 1 0]);

% Create plot
plot(X2,Y2,'Parent',subplot1,'DisplayName','Fit to Newton Cooling equation',...
    'Color',[1 0 0]);
...
% Create title
title({'Fig 2 : Temperature vs Time to Demonstrate Newton''s Law of Cooling'},...
    'FontSize',11);
...
% Create plot
plot1 = plot(Y1,Y3,'Parent',subplot2,'DisplayName','Original Data',...
    'Marker','*',...
    'LineStyle','none');
...
setLineOrder(subplot2,fitLine1,plot1);

% "Show equations" was selected
showEquations(fittypesArray1,coeffs1,3,subplot2);

% Create xlabel
xlabel({'Temperature (°C)'},'FontSize',11);

% Create title
title({'Fig 3 : Thermoelectric Voltage vs Temperature'},'FontSize',11);

% Create ylabel
ylabel({'Thermoelectric Voltage (mV)'},'FontSize',11);
...
set(legend1,...
    'Position',[0.813999022797978 0.316055291165448 0.0888399395123453 0.0550239220190277]);

% Create textbox
annotation(figure1,'textbox',...
    [0.750367107195301 0.763928944795921 0.133627015325992 0.0494417852857276],...
    'String',{'T = 224e^{(-0.00061t)} + 27'});
