...
%  Auto-generated by MATLAB on 09-Nov-2016 01:33:00
...
% Create title
title({'Temperature vs Time for the Thermoelectric Generator Experiment'});
...
% Create plot
plot1 = plot(Y1,Y2,'Parent',subplot2,'DisplayName','Original Data',...
    'Marker','*',...
    'LineStyle','none');
...
% Create title
title({'Thermoelectric Voltage vs Temperature'});

% Create ylabel
ylabel({'Thermoelectric Voltage (mV)'});
...
set(legend1,...
    'Position',[0.806656878891962 0.363636363636364 0.0898188920331481 0.0664540138224347]);
